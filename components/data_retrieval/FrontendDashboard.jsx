...
export default function FrontendDashboard() {
  ...
  // Legacy v1 and domain-specific agents are intentionally delinked.
  // This page always runs data_retrieval_agent_v2.
          ...
          <div className="mx-auto flex w-full max-w-[1880px] items-center justify-between gap-4 px-4 py-4 lg:px-6">
            ...
            <div className="flex items-center gap-3">
              <span
                ...
                title="This page always runs Data Retrieval Agent v2. Provider/model is controlled from the global navbar."
              >
                Agent v2
              </span>
              {/* <div
