        ...
        <div className="hidden lg:flex items-center gap-3">
          ...
          <div className={`flex items-center gap-2 px-3 py-2 rounded-2xl border transition-all ${pillClass}`}>
            ...
            <select
              ...
              className={`reai-native-select cursor-pointer pointer-events-auto appearance-auto rounded-lg px-2 py-1 text-[10px] font-black uppercase tracking-widest outline-none ${llmSelectClass}`}
