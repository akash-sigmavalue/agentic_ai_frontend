...
// import TicketSizeSimulation from "./components/TicketSizeSimulation";
...
// const RevSimulation = ({ embedded = false } = {}) => {
...
//         const transCountResp = await fetch(`/new_rate_simulator/simulator/simulation-transaction-counts-detailed?${params.toString()}`, {
//           method: 'POST',
...
//         {/* First Table - Unit Mix Section (Hidden) */}
//         {/* 
...
//         {/* Second Table - Revenue Table Section (Hidden) */}
//         {/* 
//         <div className="section-title fade-in-up mt-5">
...
//         </div>
// */}
//         {/* Ticket Size Simulation Section */}
//         <TicketSizeSimulation villageId={villageMeta.id} />
...
const RevSimulation = ({ embedded = false } = {}) => {
  ...
  const updateMarketAnalysis = useCallback(async () => {
    ...
    try {
      ...
      if (ticketSizeRange.length > 0) {
        const transCountResp = await fetch(apiUrl(`/new_rate_simulator/simulator/simulation-transaction-counts-detailed?${params.toString()}`), {
          method: 'POST',
          headers: { 'Content-Type': 'application/json', 'Accept': 'application/json' },
          body: JSON.stringify(ticketSizeRange),
        });
            ...
            <div className="card-body p-4">
              <div className="d-flex align-items-start">
                ...
                <div className="flex-grow-1">
                  ...
                  <div className="row g-2 text-dark small">
                    <div className="col-md-6">
                      <div><FaCheckCircle className="me-2 text-success" />Cells with formulas are highlighted in light green</div>
