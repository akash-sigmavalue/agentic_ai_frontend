...
export default function EmailCard({
  ...
  return (
    <div
      ...
      className="group rounded-3xl border border-slate-200/80 bg-gradient-to-br from-white to-slate-50/60 p-4 shadow-sm transition hover:-translate-y-0.5 hover:border-slate-300 hover:shadow-md"
    >
      <div className="flex gap-4">
        <div className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-2xl border border-slate-200 bg-white text-slate-400 shadow-sm">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex flex-col gap-2">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <h5 className="min-w-0 flex-1 text-base font-black tracking-tight text-slate-900 sm:text-[15px]">
                  <span className="line-clamp-2">{subject}</span>
                </h5>
              </div>

              <div className="flex flex-wrap items-center gap-2 text-sm text-slate-600">
                <span className="font-semibold text-slate-800">{sender || "Unknown sender"}</span>
                {sender && receiver ? <span className="text-slate-400">to</span> : null}
                {sender && receiver ? <span className="truncate text-slate-600">{receiver}</span> : null}
              </div>

              <div className="flex flex-wrap items-center gap-2 text-[11px] font-semibold text-slate-500">
                {dateLabel ? <span className="rounded-full bg-slate-100 px-2.5 py-1">{dateLabel}</span> : null}
                {typeof index === "number" ? (
                ...
                {classification && classificationCategory ? (
                  <span
                    className={[
                      "inline-flex items-center rounded-full px-2.5 py-1 uppercase tracking-[0.12em]",
            ...
            <div className="rounded-2xl border border-slate-200 bg-white/90 p-4 text-sm leading-relaxed text-slate-700">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-full bg-[#525ceb] px-4 py-2 text-xs font-bold uppercase tracking-[0.12em] text-white transition hover:bg-[#434dd8]"
              >
                Read email
              </button>
              <button
                ...
                className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-2 text-xs font-bold uppercase tracking-[0.12em] text-slate-700 transition hover:border-slate-300 hover:bg-slate-50"
              >
                Reply
              </button>
              <button
